    ...
    <div className="overflow-x-clip bg-page text-ink">
      <section className="relative overflow-hidden bg-surface">
        ...
        <Container className="relative py-16 md:py-20">
          <Reveal variant="blur" duration={0.8} className="flex max-w-[1280px] flex-col gap-4">
            <p className="text-lg font-bold leading-7 text-[#009DA6] dark:text-cyan">{t.eyebrow}</p>
            ...
            <p className="max-w-[800px] text-base leading-6 text-title">
              ...
              <a
                ...
                className="font-bold text-turquoise underline transition-colors hover:text-cyan"
              >
                {contactEmail}
              </a>{" "}
              {t.contactAfter}
      ...
      <section className="bg-page pb-16 pt-10 md:pb-20 md:pt-12">
        <Container>
          <Reveal variant="blur" duration={0.7} className="mx-auto w-full max-w-[849px]">
