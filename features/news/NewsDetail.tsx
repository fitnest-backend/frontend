  ...
  return (
    <div className="overflow-x-clip bg-page text-ink">
      <Container className="flex max-w-[846px] flex-col gap-3 py-10 md:py-16">
        <Link
          href={newsPath}
          className="inline-flex w-fit items-center gap-2 rounded-lg py-3 text-base font-semibold leading-6 text-turquoise transition-colors hover:text-cyan dark:text-cyan"
        >
          <img
        ...
        <div className="flex flex-col items-center gap-10">
          <Reveal variant="blur" duration={0.8} className="w-full">
          ...
          <Reveal variant="scale" duration={0.7} className="w-full">
